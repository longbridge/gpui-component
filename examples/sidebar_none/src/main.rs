...
impl Render for Example {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        h_flex()
            ...
            .child(
                Sidebar::new("sidebar-none-example")
            ...
            .child(
                v_flex()
                    ...
                    .gap_4()
                    .p_4()
                    .child(div().font_bold().child("Non-collapsible sidebar"))
                    .child(
                        div()
                            .flex_1()
                            .rounded(cx.theme().radius)
                            ...
                            .p_5()
                            .child("The sidebar ignores collapsed=true and remains expanded, matching shadcn's collapsible=\"none\" behavior."),
                    ),
            )
    }
}

...
The `anchor` method allows you to specify where the popover appears relative to the trigger element. It accepts both `Corners` and `Anchor` types.

**Using `Corners` type** (4 corner positions):

...
Accordion::new("my-accordion")
    .item(|item| {
        item.header("Section 1")
            .child("Content for section 1")
    })
    .item(|item| {
        item.header("Section 2")
            .child("Content for section 2")
    })
    .item(|item| {
        item.header("Section 3")
...
Accordion::new("my-accordion")
    .multiple(true)
    .item(|item| item.header("Section 1").child("Content 1"))
    .item(|item| item.header("Section 2").child("Content 2"))
```
...
Accordion::new("my-accordion")
    .small()
    .item(|item| item.header("Small Section").child("Content"))

Accordion::new("my-accordion")
    .large()
    .item(|item| item.header("Large Section").child("Content"))
```
...
Accordion::new("my-accordion")
    .disabled(true)
    .item(|item| item.header("Disabled Section").child("Content"))
```
...
Accordion::new("outer")
    .item(|item| {
        item.header("Parent Section")
            .child(
                Accordion::new("inner")
                    .item(|item| item.header("Child 1").child("Content"))
                    .item(|item| item.header("Child 2").child("Content"))
            )
    })
```

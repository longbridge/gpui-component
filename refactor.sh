...
# closure parameters
re ', &mut WindowContext\)'          ', &mut Window, &mut Context)'
re ', &mut ViewContext<([^>]+)>\)'   ', &mut Window, &mut Context<$1>)'
re '\(&mut WindowContext\)'          '(&mut Window, &mut Context)'
re '\(&mut ViewContext<([^>]+)>\)'   '(&mut Window, &mut Context<$1>)'

# function parameters
re '_: &mut WindowContext\)'          '_window: &mut Window, _cx: &mut Context)'
re '_: &mut ViewContext<([^>]+)>\)'   '_window: &mut Window, _cx: &mut Context<$1>)'
re '_: &mut WindowContext,'           '_window: &mut Window, _cx: &mut Context,'
re '_: &mut ViewContext<([^>]+)>,'    '_window: &mut Window, _cx: &mut Context<$1>,'
re '_cx: &mut WindowContext\)'        '_window: &mut Window, _cx: &mut Context)'
re '_cx: &mut ViewContext<([^>]+)>\)' '_window: &mut Window, _cx: &mut Context<$1>)'
re '_cx: &mut WindowContext,'         '_window: &mut Window, _cx: &mut Context,'
re '_cx: &mut ViewContext<([^>]+)>,'  '_window: &mut Window, _cx: &mut Context<$1>,'
re 'cx: &mut WindowContext\)'         'window: &mut Window, cx: &mut Context)'
re 'cx: &mut ViewContext<([^>]+)>\)'  'window: &mut Window, cx: &mut Context<$1>)'
re 'cx: &mut WindowContext,'          'window: &mut Window, cx: &mut Context,'
re 'cx: &mut ViewContext<([^>]+)>,'   'window: &mut Window, cx: &mut Context<$1>,'

re '_: &WindowContext\)'              '_window: &Window, _cx: &Context)'
re '_: &ViewContext<([^>]+)>\)'       '_window: &Window, _cx: &Context<$1>)'
re '_: &WindowContext,'               '_window: &Window, _cx: &Context,'
re '_: &ViewContext<([^>]+)>,'        '_window: &Window, _cx: &Context<$1>,'
re '_cx: &WindowContext\)'            '_window: &Window, _cx: &Context)'
re '_cx: &ViewContext<([^>]+)>\)'     '_window: &Window, _cx: &Context<$1>)'
re '_cx: &WindowContext,'             '_window: &Window, _cx: &Context,'
re '_cx: &ViewContext<([^>]+)>,'      '_window: &Window, _cx: &Context<$1>,'
re 'cx: &WindowContext\)'             'window: &Window, cx: &Context)'

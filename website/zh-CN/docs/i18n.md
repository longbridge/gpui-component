...
namespace 必须是 `gpui_component`，它对应 Rust crate 名称 `gpui-component`，其中连字符转换为下划线。可在 [GPUI Component 内置 locale 文件](https://github.com/longbridge/gpui-kit/blob/main/crates/ui/locales/ui.yml)中查看可用的翻译 key。

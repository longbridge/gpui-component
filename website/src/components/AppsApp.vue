...
const apps = [
    ...
    { id: "cadence", name: "Cadence", category: "work", platforms: ["macOS"], site: null, source: "https://github.com/infomiho/cadence", image: "https://github.com/user-attachments/assets/043a556c-0f65-4b83-aea2-fe0a44014bd6", blurb: { en: "A minimal native Spotify player for macOS.", zh: "macOS 上的极简原生 Spotify 播放器。" } },
...
const copy = computed(() =>
    isZh.value
        ? { kicker: "应用案例", title: "用 GPUI Component 做出来的真实应用。", lead: "下面每一个都基于 GPUI Component 构建，是人们真正下载并每天使用的桌面软件——从生产环境的交易终端，到数据库客户端、终端与系统工具。", signalCount: `${apps.length} 个应用`, signalLicense: "开源与商业产品", filterLabel: "按类别筛选", openSource: "开源", commercial: "商业产品", building: "开发中", visit: "官网", sourceLink: "源码", ctaTitle: "你也用 GPUI Component 做了应用？", ctaLead: "把它发到 Showcase 讨论区，就有机会出现在这个页面上。", ctaAction: "提交你的应用" }
        : { kicker: "App Stories", title: "Real apps, shipped with GPUI Component.", lead: "Every app below is built on GPUI Component — desktop software people download and use every day, from a production trading terminal to database clients, terminals and system utilities.", signalCount: `${apps.length} apps`, signalLicense: "Open source and commercial", filterLabel: "Filter by category", openSource: "Open source", commercial: "Commercial", building: "In development", visit: "Website", sourceLink: "Source", ctaTitle: "Built something with GPUI Component?", ctaLead: "Post it in the showcase discussion and it can appear on this page.", ctaAction: "Submit your app" },
);
</script>

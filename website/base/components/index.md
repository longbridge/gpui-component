---
title: Components
description: The complete catalog of user-facing gpui-base controls.
order: 3
---

# Components

GPUI Base components are unstyled behavior primitives. Each page documents the public import and the smallest useful composition. The live example above the page is built from `crates/base/examples` and can also run as a native GPUI application.
...
- [Input](./input.md) — A renderable text editor foundation with selection, cursor, masking, highlighting, and LSP hooks.

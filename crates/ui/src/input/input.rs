...
use gpui::{
    AnyElement, App, DefiniteLength, EdgesRefinement, Entity, InteractiveElement as _,
        ...
        div()
            ...
            .when_else(
                ...
                |this| {
                    ...
                    this.child(div().h_full().flex_1().pl(pad_l).pr(pad_r).child(
                        div().size_full().overflow_hidden().child(self.state.clone()),
                    ))
                },
            )

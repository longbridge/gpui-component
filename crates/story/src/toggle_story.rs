                ...
                h_flex()
                    ...
                    .child(
                        ToggleGroup::new("toggle-button-group1")
                            .child(Toggle::label("A").checked(checked[0]))
                            .child(Toggle::label("B").checked(checked[1]))
                            .child(Toggle::label("C").checked(checked[2]))
                            .child(Toggle::label("D").checked(checked[3]))

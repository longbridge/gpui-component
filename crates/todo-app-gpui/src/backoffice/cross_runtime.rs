...
impl CrossRuntimeBridge {
    ...
    //     let handler = Box::new(SubscribeResourceHandler {
    //         server_id,
    //         resource_uri,
    //         response: response_tx,
    //     });
    ...
    //     let handler = Box::new(UnsubscribeResourceHandler {
    //         server_id,
    //         resource_uri,
    //         response: response_tx,
    //     });
    ...
    // /// 订阅资源模板更新
    // pub async fn subscribe_to_resource_template(
    //     &self,
    //     server_id: String,
    //     uri_template: String,
    // ) -> Result<(), String> {
    ...
    //     let handler = Box::new(SubscribeResourceTemplateHandler {
    //         server_id,
    //         uri_template,
    //         response: response_tx,
    //     });
    ...
    // /// 取消订阅资源模板更新
    // pub async fn unsubscribe_from_resource_template(
    //     &self,
    //     server_id: String,
    //     uri_template: String,
    // ) -> Result<(), String> {
    ...
    //     let handler = Box::new(UnsubscribeResourceTemplateHandler {
    //         server_id,
    //         uri_template,
    //         response: response_tx,
    //     });
...
// // 相应的消息处理器
// struct SubscribeResourceHandler {
//     server_id: String,
//     resource_uri: String,
//     response: oneshot::Sender<Result<(), String>>,
// }

// impl MessageHandler for SubscribeResourceHandler {
//     fn handle(self: Box<Self>) {
//         Arbiter::new().spawn(async move {
//             let registry = McpRegistry::global();
//             // 这里需要实现具体的订阅逻辑
//             // 根据 MCP 规范调用相应的订阅方法
//             let result = Ok(()); // TODO: 实现具体的订阅逻辑
...
// /// 取消订阅资源处理器
// struct UnsubscribeResourceHandler {
//     server_id: String,
//     resource_uri: String,
//     response: oneshot::Sender<Result<(), String>>,
// }

// impl MessageHandler for UnsubscribeResourceHandler {
//     fn handle(self: Box<Self>) {
//         Arbiter::new().spawn(async move {
//             let registry = McpRegistry::global();
//             // 这里需要实现具体的取消订阅逻辑
//             // 根据 MCP 规范调用相应的取消订阅方法
//             let result = Ok(()); // TODO: 实现具体的取消订阅逻辑
//             let _ = self.response.send(result);
//         });
//     }
// }
...
// /// 订阅资源模板处理器
// struct SubscribeResourceTemplateHandler {
//     server_id: String,
//     uri_template: String,
//     response: oneshot::Sender<Result<(), String>>,
// }

// impl MessageHandler for SubscribeResourceTemplateHandler {
//     fn handle(self: Box<Self>) {
//         Arbiter::new().spawn(async move {
//             let registry = McpRegistry::global();
//             // 这里需要实现具体的订阅资源模板逻辑
//             // 根据 MCP 规范调用相应的订阅方法
//             let result = Ok(()); // TODO: 实现具体的订阅资源模板逻辑
//             let _ = self.response.send(result);
//         });
//     }
// }
...
// /// 取消订阅资源模板处理器
// struct UnsubscribeResourceTemplateHandler {
//     server_id: String,
//     uri_template: String,
//     response: oneshot::Sender<Result<(), String>>,
// }

// impl MessageHandler for UnsubscribeResourceTemplateHandler {
//     fn handle(self: Box<Self>) {
//         Arbiter::new().spawn(async move {
//             let registry = McpRegistry::global();
//             // 这里需要实现具体的取消订阅资源模板逻辑
//             // 根据 MCP 规范调用相应的取消订阅方法
//             let result = Ok(()); // TODO: 实现具体的取消订阅资源模板逻辑
//             let _ = self.response.send(result);
//         });
//     }
// }

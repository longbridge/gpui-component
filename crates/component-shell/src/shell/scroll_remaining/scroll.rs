...
fn axis_method() -> MethodDescriptor {
    ...
    .documented("Selects the native scroll axes.")
}
...
pub(super) fn register(registry: &mut ComponentRegistry) -> Result<(), RegistryError> {
    registry.register_state(
        ...
        .documented("A retained native scroll capability owned by one Scroll viewport and shared with any Scrollbar elements that control it."),
    )?;
    registry.register(ComponentDescriptor {
        ...
        materializer: Arc::new(ScrollMaterializer),
    })?;
    registry.register(ComponentDescriptor {
        name: "Scrollbar",
        constructors: vec![ConstructorDescriptor::new(
        ...
        methods: vec![
            ...
            .documented("Sets the native scrollbar visibility policy."),
            MethodDescriptor::new(
                "viewportFromLayout",
            ...
            .documented("Uses this element's layout bounds as the native viewport."),
        ],
        typescript: TypeScriptDescriptor::new(
        ...
        materializer: Arc::new(ScrollbarMaterializer),
    })?;
    Ok(())
}

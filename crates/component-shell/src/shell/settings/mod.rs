...
.with_methods(vec![text_method("description", "Sets the supporting description shown under the title.", TextOp::Description),bool_method("Setting", "defaultOpen", "Opens the page's groups by default.", BoolOp::DefaultOpen),bool_method("Setting", "resettable", "Shows the control that restores the default value.", BoolOp::Resettable)])

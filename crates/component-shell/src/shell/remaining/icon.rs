...
use gpui_shell::{
    ...
    gpui_component::{Icon, Sizable as _, Size, try_parse_color},
};
...
pub(super) fn register(registry: &mut ComponentRegistry) -> Result<(), RegistryError> {
    registry.register(ComponentDescriptor {
        ...
        methods: vec![
            ...
            .documented("Sets the semantic icon size."),
            MethodDescriptor::new(
                "color",
            ...
            .documented("Sets the icon color from a supported color token."),
            MethodDescriptor::new(
                "rotate",
            ...
            .documented("Rotates the icon by a finite number of radians."),
        ],
        ...
        materializer: Arc::new(IconMaterializer),
    })?;
    Ok(())
}

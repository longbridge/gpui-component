...
.with_methods(vec![
            ...
            MethodDescriptor::new("scrollbarVisible", vec![ArgumentDescriptor::new("vertical", ArgumentSchema::Boolean), ArgumentDescriptor::new("horizontal", ArgumentSchema::Boolean)], |args| match args { [ComponentArgument::Boolean(value), ComponentArgument::Boolean(h)] => Ok(ComponentPayload::new(Op::Scrollbars(*value, *h))), _ => Err("DataTable.scrollbarVisible expects two booleans".into()) }).with_documentation("Chooses when the table shows its scrollbars."),
            bool_method("DataTable", "rowSelectable", "Sets native DataTable behavior.", Op::RowSelectable), bool_method("DataTable", "columnSelectable", "Sets native DataTable behavior.", Op::ColSelectable), bool_method("DataTable", "cellSelectable", "Sets native DataTable behavior.", Op::CellSelectable), bool_method("DataTable", "rowHeader", "Sets native DataTable behavior.", Op::RowHeader), bool_method("DataTable", "sortable", "Sets native DataTable behavior.", Op::Sortable), bool_method("DataTable", "columnResizable", "Sets native DataTable behavior.", Op::ColResizable), bool_method("DataTable", "columnMovable", "Sets native DataTable behavior.", Op::ColMovable),
        ])
